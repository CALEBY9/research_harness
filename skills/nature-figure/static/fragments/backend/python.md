...
For explicit numeric axis limits, apply the data-visibility check in
`references/qa-contract.md` before export. The existing helper module provides
`scripts/figure_safety.py:assert_visible_points(ax, x, y)` for point centers.
