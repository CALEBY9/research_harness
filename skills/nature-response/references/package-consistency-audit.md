...
After each completed editing batch, re-run affected checks below. A successful
check on the exact unchanged final package can be reused at delivery; changes to
text, numbering, pagination or any coupled artifact require renewed checks.
