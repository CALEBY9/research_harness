...
description: Build and QA a complete Chinese academic PPTX from a paper or reading notes, with an evidence-led story, selected figures, speaker notes, and corrected layout. Use for 论文做PPT、论文汇报、组会PPT、文献汇报、答辩或会议幻灯片; not for reconstructing image-only slides.
---
