...
Terminology consistency is a cross-cutting check. For a short
`LANGUAGE_ONLY` passage, keep it internal and surface only a meaning-changing
collision. Build and expose the full Terminology Ledger for whole-manuscript
or multi-section work, visible drift, or an explicit terminology audit (see
