...
description: Reconstruct slide images, screenshots, scanned PDFs, or image-only PPTX as high-fidelity object-level editable PowerPoint with rendered QA. Use for 图片转可编辑PPT、截图还原PPT、扫描PDF恢复、流程图/知识图谱/箭头重建; not for authoring a new deck from notes.
---
