...
- Use `core/evidence-authority.md` for claim admission, canonical/version
  authority, author-controlled scientific decisions, bounded artifact mutation,
  clean-final separation, and evidence-backed completion claims.
