...
description: Build a source-grounded Paper Card for one paper, mapping its question, methods, experiments, claims, boundaries, limitations, critiques, connections, and testable ideas. Use for 单篇论文精读、文献卡片, or experiment-to-claim audit; not for full translation or formal peer review.
---
